                    ...
                    <Col lg='6'>
                        <div className="hero_content">
                            <div className="hero_subtitle d-flex align-items-center">
                                {/* <button onClick={()=>navigate("/mapOpen")} className="exp" color="#45b577"><h2>Explore hotels</h2></button> */}
                                <a href="https://apimap-a6810.web.app">
        <button className="exp">Explore Hotels</button>
      </a>
                                <img src={mImg} alt=""/>
                            </div>
                            <h1>
